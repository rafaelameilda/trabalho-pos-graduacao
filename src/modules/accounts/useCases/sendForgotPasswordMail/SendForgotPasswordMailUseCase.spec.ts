...
describe("Send Forgot Mail", () => {
  ...
  it("should not be able to send a n email if user does not exists", async () => {
    await expect(
      sendForgotPasswordMailUseCase.execute("carai@gmail.com")
  ...
  it("should be able to create an users token", async () => {
    ...
    await usersRepositoryInMemory.create({
      driver_license: "2342342",
      email: "teste2@gmail.com",
      name: "Nome de Alguem2",
      password: "123542",
    });
